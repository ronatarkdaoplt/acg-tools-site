...
import type { ArkSDKCore } from '../../core/index.js';
...
const getLogMode = function <This>(this: This): LOG_MODE {
  ...
  if (hasBus(this)) {
    logMode = (this.bus.core as ArkSDKCore)?.logMode;
  } else if (hasCore(this)) {
    logMode = (this.core as ArkSDKCore)?.logMode;
  }
